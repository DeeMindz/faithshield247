    ...
    <div className="min-h-screen flex flex-col bg-[oklch(0.97_0.01_80)]">
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-14">
        ...
        <div className="rounded-2xl bg-[oklch(0.18_0.06_255)] px-8 py-10 mb-12 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-2xl">
              A child-focused digital safeguarding and values-based technology concept, developed under Idea-Hub UK Ltd.
            </p>
          </div>
        </div>
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold text-[oklch(0.18_0.06_255)] font-display mb-5">About Idea-Hub UK Ltd</h2>
          <div className="bg-white rounded-2xl border border-[oklch(0.9_0.01_80)] p-8">
            <p className="text-[oklch(0.35_0.02_255)] leading-relaxed text-[0.95rem] mb-4">
              Idea-Hub UK Ltd is a platform committed to developing purposeful ideas, creative solutions, and socially relevant innovation. FaithShield247 is one of the initiatives emerging from that broader vision.
            </p>
            <p className="text-[oklch(0.35_0.02_255)] leading-relaxed text-[0.95rem]">
              Idea-Hub UK Ltd brings together thought, creativity, strategy, and collaboration to shape ideas that respond to real human and societal needs.
            </p>
          </div>
        </section>
