/* FaithShield247 Safety Report â€” Sacred Modernism
...
const weeklyData = {
  period: "March 19 â€“ March 25, 2026",
  overallScore: 91,
  scoreTrend: +3,
...
const monthlyData = {
  ...weeklyData,
  period: "March 1 â€“ March 25, 2026",
  overallScore: 89,
  scoreTrend: +5,
...
export default function SafetyReport() {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>FaithShield247 Safety Report â€” ${data.period}</title>
      ...
      <body>
        <div class="header">
          ...
          <div>
            ...
            <p>${period === "weekly" ? "Weekly" : "Monthly"} Report Â· ${data.period}</p>
          </div>
        </div>
        ...
        <div class="section">
          ...
          ${data.children.map((c) => `
            <div class="child-card">
              <h3>${c.name} (Age ${c.age}) â€” Protection Score: ${c.score}/100</h3>
              <div class="detail">
                <strong>Screen Time:</strong> ${c.screenTime} avg Â· <strong>Blocked:</strong> ${c.blocked} sites Â· <strong>Devotionals:</strong> ${c.devotionals} completed<br/>
                <strong>Top Sites:</strong> ${c.topSites.join(", ")}
              </div>
              ${c.concerns.length > 0 ? `<div class="concern" style="margin-top:6px">âš  Concerns: ${c.concerns.join(" Â· ")}</div>` : ""}
              ${c.positives.length > 0 ? `<div class="positive" style="margin-top:4px">âœ“ Positives: ${c.positives.join(" Â· ")}</div>` : ""}
            </div>
          `).join("")}
        </div>
        ...
        <div class="footer">
          <div class="verse">"Train up a child in the way he should go; even when he is old he will not depart from it." â€” Proverbs 22:6</div>
          <p>Generated by FaithShield247 Â· ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })} Â· faithshield247.com</p>
        </div>
      </body>
      </html>
    `);
      ...
      <div className="p-6 max-w-4xl">
        ...
        <div ref={reportRef} className="bg-white rounded-xl border border-[oklch(0.92_0.01_80)] overflow-hidden shadow-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[oklch(0.5_0.02_255)]">
                  {period === "weekly" ? "Weekly" : "Monthly"} Report Â· {data.period}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border-t-2 border-[oklch(0.72_0.12_75)] bg-[oklch(0.97_0.01_80)] text-center">
            ...
            <p className="text-xs text-[oklch(0.5_0.02_255)] mb-1">â€” Proverbs 22:6</p>
            <p className="text-[10px] text-[oklch(0.6_0.02_255)] mt-3">
              Generated by FaithShield247 Â· {new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })} Â· faithshield247.com
            </p>
          </div>
        </div>
